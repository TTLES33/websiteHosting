...
<?php 
    ...
    echo "<center>";
    echo "<div class=\"main\">";
    echo "<div class=\"tab_nadpis\">Přihlášení</div>";
    echo "<form method=\"post\" action=\"#\">";
echo "<select  name=\"uzivatele_vyber_login\">";
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    echo "<option value=". $row["id_uzivatele"].">". $row["titul"]."  ". $row["jmeno"]." ". $row["prijmeni"]."  ". $row["titul_za"]."</option>";
  }
} else {
  echo "<br> 0 results";
}
$conn->close();
    ...
    echo "</select><br>";
echo "<input type=\"password\" name=\"input_passwd\">";
echo "<br>";
