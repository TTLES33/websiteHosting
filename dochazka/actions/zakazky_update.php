...
$sql = "UPDATE zakazky SET jmeno_zakazky='$zakazka_nazev', zodpovedna_osoba_zakazky='$zakazka_osoba', zahajeni_zakazky='$zakazka_zahajeni', ukonceni_zakazky='$zakazka_ukonceni', stav_zakazky='$zakazka_stav', faktura='$faktura' WHERE id_zakazky='$zak_id' AND zakazkytable='$databasetable'";
