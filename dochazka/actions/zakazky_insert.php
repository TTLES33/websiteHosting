...
$sql = "INSERT INTO zakazky (jmeno_zakazky, zodpovedna_osoba_zakazky, zahajeni_zakazky, ukonceni_zakazky, stav_zakazky, faktura, odpracovanoJSON, kooperace, zakazkytable) 
VALUES ('$nazev', '$uzivatel', '$zahajeni', '$ukonceni', '$stav', '$faktura', '$insJSON', '$kooperace', '$databasetable');";
