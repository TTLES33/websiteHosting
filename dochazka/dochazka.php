...
<link rel="stylesheet" href="css/dochazka.css">
<script src="//code.jquery.com/jquery-3.5.1.min.js"></script>
<script src="js/global.js"></script>
<script src="js/dochazka_js.js"></script>
...
if(isset($_COOKIE["cookie_id"])) {     
            ...
            $sql = "SELECT * FROM uzivatele WHERE id_uzivatele=$prihlaseny_uzivatel_id ORDER BY prijmeni DESC";
...
<a class="sidenav_content active"  href="dochazka.php">Tisk Docházky</a>
...
<?php
    ...
    if($permission == "admin"){  
            ...
            <div class="form_input" >
                <select id="uzivatele_vyber" name="uzivatele_vyber">
                    <?php
            ...
            <input class="submit" type="submit" value="Vyhledat" id="submit" name="submit" onclick="adminLoad()" >
                </div>
            <br>
            ...
            <div class="form_input" >
            <input type="month" id="bdaymonth" name="bdaymonth">
            <input class="submit" type="submit" value="Vyhledat" onclick="userLoad()" name="submit">
            </div>
            <br>
...
}else if($input_status == "2"){    //if($input_status == "1"){      xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx

    echo "<meta http-equiv=\"refresh\" content=\"0; url='/dochazka/login/index.php?page=dochazka'\" />";
...
<button class="tisk" onclick="printDiv('vystup')">Vytisknout</button>
</div>

<!--xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx SCRIPTYxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx -->
<script>
