...
<link rel="stylesheet" href="css/vyk-prace.css">
<script src="//code.jquery.com/jquery-3.5.1.min.js"></script>
<script src="js/global.js"></script>
<script src="js/vyk-prace.js"></script>
...
$sql = "SELECT * FROM uzivatele WHERE id_uzivatele=$prihlaseny_uzivatel_id ORDER BY prijmeni ASC";
...
<a class="sidenav_content active"  href="vyk-prace.php">Výkazy Práce</a>
...
<div class="mainbox0">
<div id="ajax_vysledek" class="ajax_vysledek"></div>
<center>
<?php 
...
<form class="form_input" onsubmit="vykpraceAdmin(); return false;">
  ...
  <input class="submit" type="submit" value="Vyhledat"  name="submit">
</form>
<br>
...
?>
<script>
var uzivatel = <?php echo $prihlaseny_uzivatel_id;?>;
</script>
    <form class="form_input" onsubmit="vykpraceUser(); return false;">
  <input type="month" id="bdaymonth" name="bdaymonth">
  <input class="submit" type="submit" value="Vyhledat" name="submit">
</form>
<br>
...
<?php
    ...
    echo "<meta http-equiv=\"refresh\" content=\"0; url='/dochazka/login/index.php?page=vyk-prace'\" />";
