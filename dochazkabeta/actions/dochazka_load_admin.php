...
if ($result->num_rows > 0) {
    $status = "success";
    echo "<table class=\"dochazka_table\"><tbody>
    <tr class=\"dochazka_tr\">
    <th>Datum</th><th>Od</th><th>Do</th><th>Odpracováno</th>
    </tr>";
    ...
    while($row = $result->fetch_assoc()) {
      ...
      echo "<tr><td class=\"dochazka_td\">".$datum."</td>
      <td class=\"dochazka_td\">".$cas_od_string."</td>
      <td class=\"dochazka_td\">".$cas_do_string."</td>
